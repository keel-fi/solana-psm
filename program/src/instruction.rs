...
pub enum SwapInstruction {
    ...
    /// 
    ///   8. `[writable]` Permission account created by default ONLY FOR RedemptionRateCurve
    ///   9. `[]` Super admin, associated with permission account in 8.
    ///   10. `[writable, signer]` Payer
    ///   11. `[]` System program for account creation
    /// 
